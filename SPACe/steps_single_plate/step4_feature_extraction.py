...
class FeatureExtractor:
    ...
    def __init__(self, args):
        ...
        self.w2_mask_filepaths = sorted(self.masks_load_path.rglob("*_W2.png"))
        self.w3_mask_filepaths = sorted(self.masks_load_path.rglob("*_W3.png"))
        self.w5_mask_filepaths = sorted(self.masks_load_path.rglob("*_W5.png"))
